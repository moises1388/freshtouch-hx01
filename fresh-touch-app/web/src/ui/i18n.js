...
const T = {
  es: {
    ...
    basic_steps: ['💧 Vapor 30 segundos', '💨 Secado 50s + pausa 3s + 50s', '🔆 Desinfección UV', '🦠 Antibacterial incluido'],
    premium_steps: ['💧 Vapor 30 segundos', '💨 Secado 50s + pausa 3s + 50s', '🔆 Desinfección UV premium', '🦠 Antibacterial doble', '⭐ Ciclo profundo'],
    sel: 'SELECCIONAR',
  ...
  en: {
    ...
    basic_steps: ['💧 Steam 30 seconds', '💨 Drying 50s + 3s pause + 50s', '🔆 UV disinfection', '🦠 Antibacterial included'],
    premium_steps: ['💧 Steam 30 seconds', '💨 Drying 50s + 3s pause + 50s', '🔆 Premium UV disinfection', '🦠 Double antibacterial', '⭐ Deep cycle'],
    sel: 'SELECT',
