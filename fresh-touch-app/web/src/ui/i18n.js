...
const T = {
  es: {
    ...
    basic_steps: ['💧 Vapor 30 segundos', '💨 Secado 2 minutos', '🔆 Desinfección UV', '🦠 Antibacterial incluido'],
    premium_steps: ['💧 Vapor 45 segundos', '💨 Secado 2 minutos', '🔆 Desinfección UV premium', '🦠 Antibacterial doble', '⭐ Ciclo profundo'],
    sel: 'SELECCIONAR',
  ...
  en: {
    ...
    basic_steps: ['💧 Steam 30 seconds', '💨 Drying 2 minutes', '🔆 UV disinfection', '🦠 Antibacterial included'],
    premium_steps: ['💧 Steam 45 seconds', '💨 Drying 2 minutes', '🔆 Premium UV disinfection', '🦠 Double antibacterial', '⭐ Deep cycle'],
    sel: 'SELECT',
